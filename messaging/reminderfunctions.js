...
module.exports = function(User) {
    ...
    module.sendInfo = function() {
        ...
        "Through these ladders, we hope that we all can continue to point one another to Christ and live out Hebrews 10:24-25 - “And let us consider how to stir up one another to love and good works, not neglecting to meet together, as is the habit of some, but encouraging one another, and all the more as you see the Day drawing near.” Usually RCF Meets runs on Saturdays/Sundays, but for this upcoming week, RCF Meets will run on Sunday/Monday. \n\n" + 
        "Also, some updates! \n" +
        
        "1. Your own profile page! Type “View Profile” and click on the button that shows to open your profile page! You can view all the information you’ve given so far AND update your information too! No need to completely remake your whole profile if you want to update your information." + 
        "2. The “View Members” and “Get Started” commands are no longer valid. \n\n" +

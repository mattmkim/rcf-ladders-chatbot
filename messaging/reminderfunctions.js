...
module.exports = function(User) {
    ...
    module.sendInfo = function() {
        var message = "The first RCF Meets of the year! Woohoo! If this is your first time, welcome! Reach out to the person(s) you were paired with, and setup a time to meet! This can " + 

...
var routes = function(User) {
    ...
    var submitPreferences = function (req, res) {
        ...
        var viewMembersMessage = "In the meantime, type " + '"' + "View Profile" + '"' + " if you want see the information you've given, as well as if you want to make any updates! Type " + '"' + "View Profile" + '"' + " if you want to see a list of all valid commands.";
